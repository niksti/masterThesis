...
%Pareto efficient.
We can see that the Nash Equilibrium \{\emph{Keep}, \emph{Withhold}\} is not the optimal case for both parties, because \{\emph{Send}, $Pay\}$ increases the payout of both parties. 
