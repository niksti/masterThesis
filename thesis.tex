...
Remark: We allow \texttt{assign\_coins\_real} to be probabilistic. Throughout the whole proof, \texttt{assign\_coins\_real} is the only source of randomness in every equation involving probabilities.\newline
...
\end{equation}
For better readability, from now on we name the Seller's output value $O_S$:
...
\end{equation}%[]\texttt{assign\_coins\_real} is a deterministic function, equation~\ref{eq:real_1} and equation~\ref{eq:real_2} contradict each other. 
