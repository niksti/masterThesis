...
\[ SC_B : \{ \textit{set of transactions}\} \to \mathbb{R} \]
...
\begin{equation}
    \forall s \in \{set of Seller strategies\}: P_S(s, honest) \leq P_B(honest,honest)
\end{equation}
and
\begin{equation}
    \forall s \in \{set of Buyer strategies\}: P_B(honest, s) \leq P_S(honest,honest)
\end{equation}
...
\[ P_S(honest,honest) = SC_S(Tx_{honest}) - U_S(G) \]
\[  P_B(honest,honest) = SC_B(Tx_{honest}) + U_B(G))\]
