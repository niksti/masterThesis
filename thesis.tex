...
The Mediator is always behaving in the same way. Therefore the Seller can choose the one option, which yields him the biggest payout. This is sending the good ($H_S$) and reporting 1, as: 
...
\minisec{Friend is not the ideal Mediator}
