...
To analyze the payoff, we again start at the bottom. Since $P>C$, the Seller would comply (-C$_S$) on both instances.\newline
...
\minisec{Payoff dishonest seller}
\begin{equation}
...
\minisec{The smart contract has to change the payoff}
from (5.3), (5.4),(5.5):
...
We introduce a general payoff function $P$, that outputs the overall payoff that a player 
