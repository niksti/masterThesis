    ...
    \node[draw]{S}
        ...
        child[sibling distance = 9cm]{node[draw]{S}
            child[sibling distance = 5cm]{node[draw]{M}
    		    child[sibling distance = 3cm]{node[shape = rectangle]{$0|0$} edge from parent node [right] {1}}edge from parent node [left] {0}}
            child[sibling distance = 5cm]{node[draw]{M}
    		    child[sibling distance = 3cm]{node[shape = rectangle]{$- C_S| -P-C_B$} edge from parent node [right] {1}}edge from parent node [right] {1}}edge from parent node [right] {$-H_S$}};
\end{tikzpicture}\newline
