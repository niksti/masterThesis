...
\begin{tikzpicture}[sibling distance=7cm,level distance=6em,every node/.style={shape=circle,align=center}]
      \node[draw]{B}
        ...
        child{node[draw]{S}
            child[sibling distance = 3cm]{node[shape=rectangle]{G$|$P}edge from parent node [left] {H$_S$}}
            child[sibling distance = 3cm]{node[shape = rectangle]{P+G$|$0}edge from parent node [right] {-H$_S$}}edge from parent node [right] {-H$_B$}};
\end{tikzpicture}
...
\begin{tikzpicture}[sibling distance=10em,level distance=6em,every node/.style={shape=circle,draw,align=center}]
      \node{B}
        child{node{S}
            child{node{B}
                child{node{.}}}
            child{node{B}
                child{node{.}}}}
        child{node[shape=rectangle]{G|P}};
\end{tikzpicture}
